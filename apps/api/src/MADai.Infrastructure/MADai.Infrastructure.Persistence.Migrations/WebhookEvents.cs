...
[Migration("20260521102757_WebhookEvents")]
public class WebhookEvents : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.CreateTable("WebhookEvents", delegate(ColumnsBuilder table)
		{
			OperationBuilder<AddColumnOperation> id = table.Column<Guid>("uniqueidentifier");
			OperationBuilder<AddColumnOperation> companyId = table.Column<Guid>("uniqueidentifier");
			OperationBuilder<AddColumnOperation> endpointId = table.Column<Guid>("uniqueidentifier");
			int? maxLength = 80;
			OperationBuilder<AddColumnOperation> eventType = table.Column<string>("nvarchar(80)", null, maxLength);
			OperationBuilder<AddColumnOperation> payloadJson = table.Column<string>("nvarchar(max)");
			OperationBuilder<AddColumnOperation> createdAt = table.Column<DateTime>("datetime2");
			OperationBuilder<AddColumnOperation> deliveredAt = table.Column<DateTime>("datetime2", null, null, rowVersion: false, null, nullable: true);
			OperationBuilder<AddColumnOperation> nextAttemptAt = table.Column<DateTime>("datetime2", null, null, rowVersion: false, null, nullable: true);
			OperationBuilder<AddColumnOperation> attemptCount = table.Column<int>("int");
			OperationBuilder<AddColumnOperation> lastResponseStatus = table.Column<int>("int", null, null, rowVersion: false, null, nullable: true);
			maxLength = 2000;
			OperationBuilder<AddColumnOperation> lastError = table.Column<string>("nvarchar(2000)", null, maxLength, rowVersion: false, null, nullable: true);
			maxLength = 20;
			return new
			{
				Id = id,
				...
				LastError = lastError,
				Status = table.Column<string>("nvarchar(20)", null, maxLength)
			};
		}, null, table =>
		{
			table.PrimaryKey("PK_WebhookEvents", x => x.Id);
		});
		migrationBuilder.CreateIndex("IX_WebhookEvents_EndpointId_CreatedAt", "WebhookEvents", new string[2] { "EndpointId", "CreatedAt" });
		migrationBuilder.CreateIndex("IX_WebhookEvents_Status_NextAttemptAt", "WebhookEvents", new string[2] { "Status", "NextAttemptAt" });
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropTable("WebhookEvents");
	}
