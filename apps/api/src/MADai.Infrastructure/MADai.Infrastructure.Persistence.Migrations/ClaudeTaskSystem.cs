...
public class ClaudeTaskSystem : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.CreateTable("ClaudePromptTemplates", delegate(ColumnsBuilder table)
		{
			OperationBuilder<AddColumnOperation> id2 = table.Column<Guid>("uniqueidentifier");
			int? maxLength2 = 200;
			OperationBuilder<AddColumnOperation> name = table.Column<string>("nvarchar(200)", null, maxLength2);
			maxLength2 = 2000;
			return new
			{
				Id = id2,
				Name = name,
				Description = table.Column<string>("nvarchar(2000)", null, maxLength2, rowVersion: false, null, nullable: true),
		...
		migrationBuilder.CreateTable("ClaudeTasks", delegate(ColumnsBuilder table)
		{
			OperationBuilder<AddColumnOperation> id = table.Column<Guid>("uniqueidentifier");
			int? maxLength = 300;
			OperationBuilder<AddColumnOperation> title = table.Column<string>("nvarchar(300)", null, maxLength);
			maxLength = 8000;
			OperationBuilder<AddColumnOperation> description = table.Column<string>("nvarchar(max)", null, maxLength, rowVersion: false, null, nullable: true);
			maxLength = 8000;
			return new
			{
				Id = id,
				...
				Notes = table.Column<string>("nvarchar(max)", null, maxLength, rowVersion: false, null, nullable: true),
				Status = table.Column<int>("int"),
				Priority = table.Column<int>("int"),
				AttachmentsJson = table.Column<string>("nvarchar(max)", null, null, rowVersion: false, null, nullable: true),
				CreatedDate = table.Column<DateTime>("datetime2"),
				ModifiedDate = table.Column<DateTime>("datetime2", null, null, rowVersion: false, null, nullable: true),
				DeletedDate = table.Column<DateTime>("datetime2", null, null, rowVersion: false, null, nullable: true),
				CreatedByUserId = table.Column<Guid>("uniqueidentifier", null, null, rowVersion: false, null, nullable: true),
		...
		migrationBuilder.CreateIndex("IX_ClaudePromptTemplates_Name", "ClaudePromptTemplates", "Name", null, unique: true);
		migrationBuilder.CreateIndex("IX_ClaudeTasks_CreatedDate", "ClaudeTasks", "CreatedDate");
		migrationBuilder.CreateIndex("IX_ClaudeTasks_Status_Priority_Id", "ClaudeTasks", new string[3] { "Status", "Priority", "Id" });
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropTable("ClaudePromptTemplates");
		migrationBuilder.DropTable("ClaudeTasks");
	}
